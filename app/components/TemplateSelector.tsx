  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-center gap-2">
        <span className="text-sm font-semibold text-gray-900">预设筛选模板</span>
        <span className="text-xs text-gray-400">一键应用常用筛选组合</span>
      </div>
        ...
        {templates.map((tpl) => {
          ...
          return (
            ...
            >
              ...
              <p className="mt-1 text-[11px] text-emerald-700">{tpl.use_case}</p>
            </button>
          );
        })}
      </div>
